...
function g(e, t) {
    ...
    if (
        ge.hasData(e) &&
        ((o = ge.access(e)), (a = ge.set(t, o)), (c = o.events))
    )
...
function _(e) {
    ...
    n ||
        (("none" !== (n = b(e, t)) && n) ||
        ((t = (qe = (
            qe || K("<iframe frameborder='0' width='0' height='0'/>")
...
function S(e, t, n) {
    ...
    if (i <= 0 || null == i) {
    if ((((i = w(e, t, o)) < 0 || null == i) && (i = e.style[t]), $e.test(i)))
        return i
    ...
    */
    ...
    function y(e, t, n, i, o, a) {
        ...
        r(function (r, a, s, u) {
            ...
            b = n ? (o || (r ? e : p || i) ? [] : a) : v
            if ((n && n(v, b, s, u), i))
            for (c = g(b, h), i(c, [], s, u), l = c.length; l--; )
                (f = c[l]) && (b[h[l]] = !(v[h[l]] = f))
            if (r) {
            if (o || e) {
                if (o) {
    ...
    (N = t.setDocument =
        ...
        return n !== O && 9 === n.nodeType && n.documentElement
            ...
            (P = []),
            (L = []),
            (w.qsa = ye.test(n.querySelectorAll)) &&
                (i(function (e) {
                ;(e.innerHTML =
            ...
            (U = t
                ? function (e, t) {
                    ...
                    (!w.sortDetached && t.compareDocumentPosition(e) === r)
                        ? e === n || (e.ownerDocument === q && Y(q, e))
                        ? -1
                        : t === n || (t.ownerDocument === q && Y(q, t))
                        ? 1
                        : M
    ...
    (t.matchesSelector = function (e, n) {
        ...
        (n = n.replace(fe, "='$1']")),
        w.matchesSelector && F && (!P || !P.test(n)) && (!L || !L.test(n)))
        )
        try {
            var r = I.call(e, n)
            if (
    ...
    (t.attr = function (e, t) {
        ...
        r =
            n && V.call(x.attrHandle, t.toLowerCase()) ? n(e, t, !F) : undefined
        return r !== undefined
        ? r
        : w.attributes || !F
        ? e.getAttribute(t)
    ...
    return (
        ...
        function (e, t, n, r) {
            ...
            return (
            (c || S(e, f))(r, t, !F, n, (be.test(e) && l(t.parentNode)) || t),
            n
            )
        }),
...
;((K.fn.init = function (e, t) {
    ...
    if (n[1]) {
        ...
        K.merge(
            this,
            K.parseHTML(n[1], t && t.nodeType ? t.ownerDocument || t : Z, !0)
        ),
...
K.extend({
    ...
    function (e, t) {
        ...
        return (
            ...
            this.length > 1 &&
            (fe[e] || K.unique(i), le.test(e) && i.reverse()),
            this.pushStack(i)
        )
        }
    }
...
;(K.Callbacks = function (e) {
    ...
    return (
        ...
        "complete" === Z.readyState
            ? setTimeout(K.ready)
            : (Z.addEventListener("DOMContentLoaded", a, !1),
    ...
    data: function (e, t) {
        ...
        : me(
            ...
            function (t) {
                ...
                r = K.camelCase(e)
                if (o && t === undefined)
                return (n = ye.get(o, e)) !== undefined
                    ? n
                    : (n = ye.get(o, r)) !== undefined
                    ? n
                    : (n = u(o, r, undefined)) !== undefined
                    ? n
                    : void 0
                this.each(function () {
                var n = ye.get(this, r)
...
;(K.event = {
    ...
    if (g)
        ...
        n.handler && ((n = (o = n).handler), (i = o.selector)),
            ...
            (a = g.handle =
                function (t) {
                return typeof K !== Se && K.event.triggered !== t.type
                    ? K.event.dispatch.apply(e, arguments)
                    : undefined
                }),
            c = (t = (t || "").match(he) || [""]).length;
        c--;
    ...
    if (
        ...
        3 !== r.nodeType &&
        8 !== r.nodeType &&
        !Me.test(h + K.event.triggered) &&
        (h.indexOf(".") >= 0 && ((h = (p = h.split(".")).shift()), p.sort()),
        (c = h.indexOf(":") < 0 && "on" + h),
        ((t = t[K.expando]
            ? t
        ...
        for (
            u = f.delegateType || h, Me.test(u + h) || (a = a.parentNode);
            a;
            a = a.parentNode
        )
            d.push(a), (s = a)
    ...
    for (
        a ||
        (this.fixHooks[i] = a =
            Ae.test(i) ? this.mouseHooks : De.test(i) ? this.keyHooks : {}),
    ...
    on: function (e, t, n, r, i) {
        var o, a
        if ("object" == typeof e) {
        for (a in ("string" != typeof t && ((n = n || t), (t = undefined)),
        e))
            this.on(a, t, n, e[a], i)
        return this
        }
...
;(He.optgroup = He.option),
    ...
    domManip: function (e, t) {
        ...
        d = e[0],
        m = K.isFunction(d)
        if (m || (c > 1 && "string" == typeof d && !X.checkClone && Le.test(d)))
        ...
        if (o)
            ...
            (a = i[u]),
                ...
                (a.src
                    ...
                    : K.globalEval(a.textContent.replace(Ye, "")))
        }
        return this
    },
    }),
...
K.extend({
    ...
    K.cssHooks[t] = {
        get: function (e, n, r) {
        if (n)
            return Ge.test(K.css(e, "display")) && 0 === e.offsetWidth
            ? K.swap(e, Qe, function () {
                return S(e, t, r)
                })
            : S(e, t, r)
        },
        ...
        return T(
            e,
            n,
            r ? C(e, t, r, "border-box" === K.css(e, "boxSizing", !1, i), i) : 0
        )
        },
    }
    }),
    ...
    if (t)
        return K.swap(e, { display: "inline-block" }, w, [e, "marginRight"])
    })),
...
;(dt = _t.exec(ht.toLowerCase()) || []),
    ...
    ajax: function (e, t) {
        ...
        2 !== b &&
            ...
            ? (f.ifModified &&
                ...
                : 304 === e
                ? (x = "notmodified")
                : ((x = v.state), (l = v.data), (u = !(y = v.error))))
        ...
        return w.abort()
        for (l in ((_ = "abort"), { success: 1, error: 1, complete: 1 }))
        w[l](f[l])
        if ((r = P(xt, f, t, w))) {
        ;(w.readyState = 1),
    ...
    K[t] = function (e, n, r, i) {
        return (
        K.isFunction(n) && ((i = i || r), (r = n), (n = undefined)),
...
;(K.param = function (e, t) {
    ...
    if (
    (t === undefined && (t = K.ajaxSettings && K.ajaxSettings.traditional),
...
(function (e, t) {
    ...
    var n,
        r,
        i = {}
    if (a(t)) for (n = 0, r = t.length; n < r; n++) i[t[n]] = !0
    else i[t] = !0
    for (n = 0, r = e.length; n < r; n++)
        i[e[n]] !== undefined && (e.splice(n, 1), r--, n--)
    return e
    }
    function u(e, t) {
    var n, r
    ...
    (r.find_uri_expression =
        /\b((?:[a-z][\w-]+:(?:\/{1,3}|[a-z0-9%])|www\d{0,3}[.]|[a-z0-9.\-]+[.][a-z]{2,4}\/)(?:[^\s()<>]+|\(([^\s()<>]+|(\([^\s()<>]+\)))*\))+(?:\(([^\s()<>]+|(\([^\s()<>]+\)))*\)|[^\s`!()\[\]{};:'".,<>?\xab\xbb\u201c\u201d\u2018\u2019]))/gi),
    (r.defaultPorts = {
        http: "80",
        https: "443",
        ftp: "21",
    ...
    var h,
    p = { encode: "encode", decode: "decode" },
    m = function (e, t) {
        return function (n) {
        return r[t](n + "").replace(
            r.characters[e][t].expression,
            function (n) {
    ...
    return (
        ...
        ? ((t.protocol = ""),
            (e = e.substring(2)),
            (e = r.parseAuthority(e, t)))
        : (n = e.indexOf(":")) > -1 &&
            ((t.protocol = e.substring(0, n)),
            t.protocol && !t.protocol.match(r.protocol_expression)
            ? (t.protocol = undefined)
            : "file" === t.protocol
            ? (e = e.substring(n + 3))
            : "//" === e.substring(n + 1, n + 3)
            ? ((e = e.substring(n + 3)), (e = r.parseAuthority(e, t)))
    ...
    for (
        var t, n, i, o = {}, a = e.split("&"), s = a.length, u = 0;
        u < s;
        u++
    )
        (t = a[u].split("=")),
        ...
        o[n]
            ? ("string" == typeof o[n] && (o[n] = [o[n]]), o[n].push(i))
            : (o[n] = i)
    return o
    }),
    (r.build = function (e) {
    ...
    var t = ""
    return e.hostname
        ? (r.ip6_expression.test(e.hostname)
            ? e.port
            ? (t += "[" + e.hostname + "]:" + e.port)
            : (t += e.hostname)
            : ((t += e.hostname), e.port && (t += ":" + e.port)),
        t)
        : ""
    }),
    ...
    for (i in e)
        if (d.call(e, i) && i)
        if (a(e[i]))
            for (n = {}, o = 0, s = e[i].length; o < s; o++)
            e[i][o] !== undefined &&
                n[e[i][o] + ""] === undefined &&
                ((u += "&" + r.buildQueryParameter(i, e[i][o])),
                !0 !== t && (n[e[i][o] + ""] = !0))
    ...
    var i, o, u
    if (a(t)) for (i = 0, o = t.length; i < o; i++) e[t[i]] = undefined
    ...
    if ("object" == typeof t) {
        for (var s in t) if (d.call(t, s) && !r.hasQuery(e, s, t[s])) return !1
        return !0
    }
    if ("string" != typeof t)
        throw new TypeError(
    ...
    return (
        ...
        : (e === undefined || this._deferred_build) &&
    ...
    return function (t, n) {
        return t === undefined
        ? this._parts[e] || ""
        : ((this._parts[e] = t), this.build(!n), this)
    }
    }),
    (p = {
    protocol: "protocol",
    ...
    return (
        (this._parts.path = e ? r.recodePath(e) : "/"), this.build(!t), this
    )
    }),
    (f.path = f.pathname),
    (f.href = function (e, t) {
        ...
        if (
        (!i && o && e.pathname !== undefined && (e = e.toString()),
        "string" == typeof e)
        )
    ...
    if (
        e !== undefined &&
        e &&
        (e = e.replace(/:(\/\/)?$/, "")).match(/[^a-zA-z0-9\.+-]/)
    )
        throw new TypeError(
        "Protocol '" + e + "' contains characters other than [A-Z0-9.+-]"
        )
    ...
    (f.host = function (e, t) {
        ...
        : e === undefined
        ? this._parts.hostname
            ? r.buildHost(this._parts)
            : ""
        : (r.parseHost(e, this._parts), this.build(!t), this)
    }),
    (f.authority = function (e, t) {
        ...
        : e === undefined
        ? this._parts.hostname
            ? r.buildAuthority(this._parts)
            : ""
        : (r.parseAuthority(e, this._parts), this.build(!t), this)
    }),
    ...
    (f.domain = function (e, t) {
        if (this._parts.urn) return e === undefined ? "" : this
        if (
        ("boolean" == typeof e && ((t = e), (e = undefined)), e === undefined)
        ) {
        if (!this._parts.hostname || this.is("IP")) return ""
        ...
        if ((r.ensureValidHostname(e), !this._parts.hostname || this.is("IP")))
    ...
    (f.segment = function (e, t, n) {
        ...
        s = i.split(r)
        if (
        ("number" != typeof e && ((n = t), (t = e), (e = undefined)),
        ...
        t === undefined
            ...
            ? s
            : s[e]
            : (null === e || s[e] === undefined
                ? a(t)
                ? (s = t)
                : (t || ("string" == typeof t && t.length)) &&
    ...
    (f.query = function (e, t) {
        ...
        var n = r.parseQuery(this._parts.query),
            i = e.call(this, n)
        return (
            (this._parts.query = r.buildQuery(
            i || n,
    ...
    (f.setQuery = function (e, t, n) {
        ...
        if ("object" == typeof e) for (var o in e) d.call(e, o) && (i[o] = e[o])
        else {
        if ("string" != typeof e)
            throw new TypeError(
            "URI.addQuery() accepts an object, string as the name parameter"
    ...
    (f.addQuery = function (e, t, n) {
        var i = r.parseQuery(this._parts.query)
        return (
        r.addQuery(i, e, t === undefined ? null : t),
        (this._parts.query = r.buildQuery(
            i,
            this._parts.duplicateQueryParameters
        )),
    ...
    (f.normalizePort = function (e) {
        return (
        "string" == typeof this._parts.protocol &&
            this._parts.port === r.defaultPorts[this._parts.protocol] &&
    ...
    (f.normalizePath = function (e) {
        ...
        for (
        "/" !== o.charAt(0) &&
            ("." === o.charAt(0) && o.substring(0, o.indexOf("/")),
            (t = !0),
            (o = "/" + o)),
            o = o.replace(/(\/(\.\/)+)|\/{2,}/g, "/");
        -1 !== (n = o.indexOf("/../"));
        ...
        return (
        t && this.is("relative") && (o = o.substring(1)),
        (o = r.recodePath(o)),
        (this._parts.path = o),
        this.build(!e),
        this
    ...
    (f.normalizeQuery = function (e) {
        ...
        "string" == typeof this._parts.query &&
            ...
            ? this.query(r.parseQuery(this._parts.query))
    ...
    (f.readable = function () {
        ...
        for (
            var i = "", o = 0, a = t._parts.query.split("&"), s = a.length;
            o < s;
            o++
        ) {
            var u = (a[o] || "").split("=")
            ...
            u[1] !== undefined &&
                (i += "=" + r.decodeQuery(u[1]).replace(/&/g, "%26"))
        }
        n += "?" + i.substring(1)
        }
        return (n += t.hash())
    ...
    (f.absoluteTo = function (e) {
        ...
        if (this._parts.urn)
        throw new Error(
            "URNs do not have any generally defined hierachical components"
        )
        if (
    ...
    (f.relativeTo = function (e) {
        ...
        return (s._parts.path = s.filename()), s.build()
        if ((n.substring(t.length), (a = o.substring(t.length)), n + "/" === t))
        return a && (a += "/"), (s._parts.path = a + s.filename()), s.build()
        for (
        var f = "../",
            d = new RegExp("^" + i(t)),
            h = n.replace(d, "/").match(/\//g).length - 1;
        h--;
    ...
    (f.equals = function (e) {
        ...
        for (i in l) if (d.call(l, i) && !f[i]) return !1
        return !0
    }),
...
(Views.AffiliatesTracker = class {
    ...
    const e = window.location.href,
        t = URI.parse(e),
        n =
        t.query && !t.query.includes("redirect_back")
            ? `&url=${encodeURIComponent(e)}&referrer=${encodeURIComponent(
                document.referrer
            )}`
            : "",
        r = t.query ? `?${t.query}${n}` : "",
...
function () {
    ...
    return function (t, n, r) {
        n = b(n, r)
        for (
        var i = null != t && t.length, o = e > 0 ? 0 : i - 1;
        o >= 0 && o < i;
        o += e
        )
    ...
    (y.find = y.detect =
        ...
        var r
        if (
            void 0 !== (r = k(e) ? y.findIndex(e, t, n) : y.findKey(e, t, n)) &&
            -1 !== r
        )
            return e[r]
        }),
    ...
    (y.every = y.all =
        ...
        t = b(t, n)
        for (
            var r = !k(e) && y.keys(e), i = (r || e).length, o = 0;
            o < i;
            o++
        ) {
            var a = r ? r[o] : o
    ...
    (y.max = function (e, t, n) {
        ...
        (t = b(t, n)),
            ...
            ;((i = t(e, n, r)) > a || (i === -Infinity && o === -Infinity)) &&
                ((o = e), (a = i))
            })
        return o
    }),
    ...
    (y.shuffle = function (e) {
        for (
        var t, n = k(e) ? e : y.values(e), r = n.length, i = Array(r), o = 0;
        o < r;
        o++
        )
    ...
    (y.sample = function (e, t, n) {
        return null == t || n
        ? (k(e) || (e = y.values(e)), e[y.random(e.length - 1)])
        : y.shuffle(e).slice(0, Math.max(0, t))
    }),
    ...
    (y.uniq = y.unique =
        ...
        for (var i = [], o = [], a = 0, s = e.length; a < s; a++) {
            ...
            ? ((a && o === c) || i.push(u), (o = c))
            : n
            ? y.contains(o, c) || (o.push(c), i.push(u))
            : y.contains(i, u) || i.push(u)
        }
        return i
        }),
    (y.union = function () {
    ...
    (y.intersection = function (e) {
        if (null == e) return []
        for (
        var t = [], n = arguments.length, r = 0, i = e.length;
        r < i;
        r++
        ) {
        var o = e[r]
    ...
    (y.unzip = function (e) {
        for (
        var t = (e && y.max(e, "length").length) || 0, n = Array(t), r = 0;
        r < t;
        r++
        )
        n[r] = y.pluck(e, r)
    ...
    (y.lastIndexOf = function (e, t, n) {
        var r = e ? e.length : 0
        if (
        ("number" == typeof n && (r = n < 0 ? r + n + 1 : Math.min(r, n + 1)),
        t != t)
        )
    ...
    (y.isEmpty = function (e) {
        return (
        null == e ||
        (k(e) && (y.isArray(e) || y.isString(e) || y.isArguments(e))
            ? 0 === e.length
            : 0 === y.keys(e).length)
        )
    }),
...
function (e) {
    ...
    a && e._d.setTime(+e._d + a * n),
        (s || u) && ((i = e.minute()), (o = e.hour())),
        s && e.date(e.date() + s * n),
        u && e.month(e.month() + u * n),
        a && !r && re.updateOffset(e),
        (s || u) && (e.minute(i), e.hour(o))
    }
    function d(e) {
    ...
    var t = +e,
        n = 0
    return (
        0 !== t && isFinite(t) && (n = t >= 0 ? Math.floor(t) : Math.ceil(t)), n
    )
    }
    function b(e, t) {
    ...
    e._a &&
        -2 === e._pf.overflow &&
        ((t =
        e._a[ce] < 0 || e._a[ce] > 11
            ? ce
            : e._a[le] < 1 || e._a[le] > b(e._a[ue], e._a[ce])
            ? le
            : e._a[fe] < 0 || e._a[fe] > 23
            ? fe
            : e._a[de] < 0 || e._a[de] > 59
            ? de
            : e._a[he] < 0 || e._a[he] > 59
            ? he
            : e._a[pe] < 0 || e._a[pe] > 999
            ? pe
            : -1),
    ...
    for (; o < e.length; ) {
        for (
        t = (i = T(e[o]).split("-")).length,
            r = (r = T(e[o + 1])) ? r.split("-") : null;
        t > 0;
    ...
    function N(e, t) {
    return e.isValid()
        ? ((t = O(t, e.lang())), Be[t] || (Be[t] = E(t)), Be[t](e))
        : e.lang().invalidDate()
    }
    function O(e, t) {
    function n(e) {
    ...
    for (xe.lastIndex = 0; r >= 0 && xe.test(e); )
        (e = e.replace(xe, n)), (xe.lastIndex = 0), (r -= 1)
    return e
    }
    function j(e, t) {
    var n = t._strict
    ...
    var t,
        ...
        u = s.length,
        c = 0
    for (r = O(e._f, a).match(we) || [], t = 0; t < r.length; t++)
        (i = r[t]),
        (n = (s.match(j(i, e)) || [])[0]) &&
            ...
            (c += n.length)),
        Xe[i]
            ? (n ? (e._pf.empty = !1) : e._pf.unusedTokens.push(i), L(i, n, e))
            : e._strict && !n && e._pf.unusedTokens.push(i)
    ...
    var t = e._i,
        n = e._f
    return null === t
        ? re.invalid({ nullInput: !0 })
        : ("string" == typeof t && (e._i = t = A().preparse(t)),
        re.isMoment(t)
            ? ((e = u(t))._d = new Date(+t._d))
            : n
            ? d(n)
            ? z(e)
            : H(e)
    ...
    re.fn[e] = re.fn[e + "s"] = function (e) {
        ...
        return null != e
        ? (this._d["set" + n + t](e), re.updateOffset(this), this)
        : this._d["get" + n + t]()
    }
    }
    function ee(e) {
    ...
    var re,
        ...
        ze = /([\+\-]|\d\d)/gi,
        $e = "Date|Hours|Minutes|Seconds|Milliseconds".split("|"),
        We = {
        Milliseconds: 1,
        Seconds: 1e3,
        Minutes: 6e4,
        ...
        Be = {},
        Qe = "DDD w W M D d".split(" "),
        Ve = "M D H h m s w W".split(" "),
        Xe = {
        M: function () {
            return this.month() + 1
        },
    ...
    Xe.DDDD = n(Xe.DDD, 3),
        ...
        return e
            ? (t ? S(T(e), t) : null === t ? (D(e), (e = "en")) : me[e] || A(e),
            (re.duration.fn._lang = re.fn._lang = A(e))._abbr)
            : re.fn._lang._abbr
        },
    ...
    re.normalizeUnits = function (e) {
        ...
        isDSTShifted: function () {
            ...
            p(
                this._a,
                (this._isUTC ? re.utc(this._a) : re(this._a)).toArray()
            ) > 0
            )
        },
        ...
        add: function (e, t) {
            ...
            f(
                this,
                "string" == typeof e ? re.duration(+t, e) : re.duration(e, t),
                1
            ),
            this
            )
        ...
        diff: function (e, t, n) {
            ...
            "year" === (t = m(t)) || "month" === t
                ...
                (i +=
                    (this -
                    re(this).startOf("month") -
                    (o - re(o).startOf("month"))) /
                    r),
                (i -=
                    (6e4 *
                    (this.zone() -
                        re(this).startOf("month").zone() -
                        (o.zone() - re(o).startOf("month").zone()))) /
                    r),
                "year" === t && (i /= 12))
                : ((r = this - o),
                (i =
        ...
        day: function (e) {
            ...
            return null != e
            ? ((e = B(e, this.lang())), this.add({ d: e - t }))
            : t
        },
        month: function (e) {
            var t,
            ...
            return null != e
            ? "string" == typeof e &&
                "number" != typeof (e = this.lang().monthsParse(e))
                ? this
                : ((t = this.date()),
                this.date(1),
        ...
        dayOfYear: function (e) {
            var t =
            se((re(this).startOf("day") - re(this).startOf("year")) / 864e5) +
            1
    ...
    as: function (e) {
        return this[
        "as" + (e = m(e)).charAt(0).toUpperCase() + e.slice(1) + "s"
        ]()
    },
    lang: re.fn.lang,
    toIsoString: function () {
    ...
    We))
    We.hasOwnProperty(ie) && (te(ie, We[ie]), ee(ie.toLowerCase()))
    te("Weeks", 6048e5),
    ...
    ye
        ? ((module.exports = re), ne(!0))
        : "function" == typeof define && define.amd
        ? define("moment", function (t, n, r) {
            return (
            r.config &&
                r.config() &&
                !0 !== r.config().noGlobal &&
                ne(r.config().noGlobal === e),
            re
            )
        })
        : ne()
...
function () {
    ...
    (Market.Helpers.GoogleAnalytics = {
        ...
        if (
            ((i = (o = null != e ? e : {}).page),
            (c = o.title),
            window.ga && window._envGaTrackerNames)
        ) {
            for (
            t = _.omit(
                {
                ...
                s = [],
                n = 0,
                r = (a = window._envGaTrackerNames).length;
            n < r;
            n++
            )
            (u = a[n]), s.push(ga(u + ".send", t))
            return s
        }
        },
        ...
        if (
            ...
            i = _.omit(
                ...
                h = [],
                s = 0,
                c = (d = window._envGaTrackerNames).length;
            s < c;
            s++
            )
            (p = d[s]), h.push(ga(p + ".send", i))
            return h
        }
        },
        ...
        if (window.ga && window._envGaTrackerNames) {
            for (
            o = [], t = 0, n = (i = window._envGaTrackerNames).length;
            t < n;
            t++
            )
            (a = i[t]),
                ...
                (function () {
                    var t, n, i, o
                    for (
                    o = [], t = 0, n = (i = e.productsArray).length;
                    t < n;
                    t++
                    )
                    (r = i[t]), o.push(ga(a + ".ec:addProduct", r))
                    return o
                })()
                )
            return o
        ...
        if (window.ga && window._envGaTrackerNames) {
            for (
            a = [], t = 0, n = (o = window._envGaTrackerNames).length;
            t < n;
            t++
            )
            (s = o[t]),
                ...
                (function () {
                    ...
                    (r = e[t]),
                        ...
                        (function () {
                            var e, t, n, o
                            for (
                            o = [], e = 0, t = (n = r.productsArray).length;
                            e < t;
                            e++
                            )
                            (i = n[e]), o.push(ga(s + ".ec:addImpression", i))
                            return o
                        })()
                        )
                    return o
        ...
        if (window.ga && window._envGaTrackerNames) {
            for (
            i = [], t = 0, n = (r = window._envGaTrackerNames).length;
            t < n;
            t++
            )
            (o = r[t]), i.push(ga(o + ".ec:addPromo", e))
            return i
        }
        },
        set: function (e, t) {
        ...
        if (window.ga && window._envGaTrackerNames) {
            for (
            o = [], n = 0, r = (i = window._envGaTrackerNames).length;
            n < r;
            n++
            )
            (a = i[n]), o.push(ga(a + ".set", e, t))
            return o
        }
        },
        ...
        if (window.ga && window._envGaTrackerNames) {
            ...
            (a = i[n]),
                null != t
                ? o.push(ga(a + ".ec:setAction", e, t))
                : o.push(ga(a + ".ec:setAction", e))
            return o
        }
        },
...
function () {
    ...
    function t(t) {
        var n
        ;(this.handleBuyNow = e(this.handleBuyNow, this)),
        (this.handleLogo = e(this.handleLogo, this)),
        (this.handleOnLoad = e(this.handleOnLoad, this)),
        (this.itemId = t.data().itemId),
        t.find(".header-envato_market").on("click", this.handleLogo),
        t.find(".header-buy-now").on("click", this.handleBuyNow),
        t.on(
            "click",
            ".js-track-on-click",
            ((n = this),
            function (e) {
            return (
                (n.target = $(e.currentTarget)),
                (n.experimentId = n.target.data().experimentId),
                (n.gaVariantId = n.target.data().gaVariantId),
                Market.Helpers.GoogleAnalytics.sendEvent(
                "event",
                "experiment",
                "click",
    ...
    return (
        ...
        return Market.Helpers.GoogleAnalytics.sendEvent(
            "event",
            "preview banner",
            "impression",
        ...
        var e
        return (
            (e = $(event.target).text().toLowerCase()),
            Market.Helpers.GoogleAnalytics.sendEvent(
            "event",
            "preview banner",
            "click;button",
...
function () {
    ...
    function t(t) {
        ...
        (this.hasMobileSafariIFrameBug = e(
            this.hasMobileSafariIFrameBug,
            this
        )),
        (this.fixResponsivenessForMobileSafari = e(
            this.fixResponsivenessForMobileSafari,
            this
        )),
        (this.$el = t),
    ...
    return (
        (t.prototype.fixResponsivenessForMobileSafari = function () {
...
window.addEventListener("CookiebotOnDialogDisplay", function (e) {
    ...
    e.forEach(function () {
        t.style.transform.match(t.style.top) ||
        (t.style.setProperty("transform", "translateY(" + t.style.top + ")"),
